...
def insert_data_from_csv(file_path):
    ...
    db = client["CustomerShopping"]  # Ganti dengan nama database yang diinginkan
...
if __name__ == "__main__":
    file_path = "/Users/afif/Documents/Semester6/Pemodelan dan Simulasi Data/Tugas3/Training_dataset.csv"  # Ganti dengan path dataset yang sesuai
